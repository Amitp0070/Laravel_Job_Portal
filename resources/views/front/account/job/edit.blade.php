                        ...
                        <div class="card-body card-form p-4">
                            ...
                            <div class="mb-4">
                                ...
                                <textarea  class="form-control" name="responsibility" id="responsibility" cols="5"
                                    rows="5" placeholder="Responsibility">{{ $job->resposibility }}</textarea>
                            </div>
                            <div class="mb-4">
                            ...
                            <div class="mb-4">
                                ...
                                <input value="{{ $job->company_website }}" type="text" placeholder="Website" id="company_website" name="company_website"
                                    class="form-control">
                            </div>
                        </div>
